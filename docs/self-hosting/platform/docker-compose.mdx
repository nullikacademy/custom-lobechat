---
title: Deploy OpenGPT with Docker Compose
description: >-
  Learn how to deploy the OpenGPT service using Docker Compose. Follow
...
We provide a [Docker image][docker-release-link] for deploying the OpenGPT service on your private device.
