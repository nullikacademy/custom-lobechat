---
title: Deploy OpenGPT on Zeabur
description: >-
  Learn how to deploy OpenGPT on Zeabur with ease. Follow the provided steps to
...
# Deploy OpenGPT with Zeabur

If you want to deploy OpenGPT on Zeabur, you can follow the steps below:
