---
title: Enhance Your OpenGPT Assistant with Plugins
description: >-
  Learn how to expand your OpenGPT assistant's capabilities by enabling and
...
The plugin system is a key element in expanding the capabilities of assistants in OpenGPT. You can enhance the assistant's abilities by enabling a variety of plugins.

Watch the following video to quickly get started with using OpenGPT plugins:
...
The Plugin Store allows you to directly install and use plugins within OpenGPT.
