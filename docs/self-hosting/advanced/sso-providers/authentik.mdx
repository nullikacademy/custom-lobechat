---
title: Configuring Authentik Authentication Service for OpenGPT
description: >-
  Learn how to configure Authentik for Single Sign-On (SSO) for OpenGPT,
  including creating an application provider, setting environment variables, and
  deployment instructions.
tags:
  - Authentik Configuration
  - Single Sign-On (SSO)
  - OpenGPT Authentication
...
<Callout type={'info'}>
  After a successful deployment, users will be able to use OpenGPT by authenticating with the users
