---
title: Configure ZITADEL Authentication Service for OpenGPT
description: >-
  Learn how to configure ZITADEL Authentication Service for OpenGPT deployment,
...
<Callout>
  After successful deployment, users will be able to authenticate and use OpenGPT using existing
