---
title: Deploy OpenGPT with Docker
description: >-
  Learn how to deploy the OpenGPT service using Docker, including installation
...
We provide a [Docker image][docker-release-link] for you to deploy the OpenGPT service on your private device.
...
Use the following command to start the OpenGPT service with one click:
...
- For the complete list of environment variables supported by OpenGPT, please refer to the [Environment Variables](/docs/self-hosting/environment-ariable) section.
