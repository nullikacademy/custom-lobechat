---
title: Deploy OpenGPT with Netlify - Step-by-Step Guide
description: >-
  Learn how to deploy OpenGPT on Netlify with detailed instructions on forking
...
# Deploy OpenGPT with Netlify

If you want to deploy OpenGPT on Netlify, you can follow these steps:

## Deploy OpenGPT with Netlify

<Steps>
  ### Fork the OpenGPT Repository

Click the Fork button to fork the OpenGPT repository to your GitHub account.
...
Next, select the OpenGPT project:

<Image
  alt={'Select the OpenGPT github project'}
  height={228}
  inStep
...
<Image
  alt={'Configure OpenGPT site name'}
  height={712}
  inStep
...
<Image
  alt={'Add OpenGPT site environment variables'}
  height={537}
  inStep
...
<Callout type={'tip'}>
  For a complete list of environment variables supported by OpenGPT, please refer to the [📘
...
Upon entering the deployment details, you will see the following interface, indicating that your OpenGPT is currently being deployed. Simply wait for the deployment to complete.

<Image
  alt={'OpenGPT deployment in progress'}
  height={325}
  inStep
...
If your Deploy Log in the interface looks like the following, it means your OpenGPT has been successfully deployed.
...
At this point, you can click on "Open production deploy" to access your OpenGPT site.

  <Image alt={'Access Your OpenGPT Site'} height={527} inStep src={'https://github.com/lobehub/lobe-chat/assets/28616219/b04723eb-64ad-4028-a901-dc4e4ee2d0c1'} />
</Steps>
