---
title: OpenGPT support Progressive Web Apps (PWA)
description: >-
  Discover how OpenGPT utilizes Progressive Web App (PWA) technology to provide
  a seamless and near-native app experience on both desktop and mobile devices.
  Learn how to install OpenGPT as a desktop app for enhanced convenience.
tags:
  - Progressive Web App
  - PWA
  - OpenGPT
