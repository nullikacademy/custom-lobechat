---
title: Using Ollama in OpenGPT
description: 了解如何在 OpenGPT 中使用 Ollama 框架，以增强您的应用程序。
tags:
  - Ollama
  - OpenGPT
  - 语言模型
...
# Using Ollama in OpenGPT

<Image
  alt={'Using Ollama in OpenGPT'}
  borderless
  cover
...
This document will guide you on how to use Ollama in OpenGPT:
...
Next, you can start conversing with the local LLM using OpenGPT.
...
/>
  ...
  <Callout type={'info'}>
    ...
    OpenGPT to meet the integration requirements with Ollama.
