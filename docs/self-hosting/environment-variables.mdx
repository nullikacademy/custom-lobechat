---
title: OpenGPT Environment Variables - Customizing Guide
description: >-
  Learn how to customize OpenGPT configuration using environment variables for
...
OpenGPT provides some additional configuration options when deployed, which can be customized using environment variables.
